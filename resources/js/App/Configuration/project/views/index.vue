...
import { _items } from "@/App/Configuration/project/services";

import { itemsResponse } from "@/Shared/constants";

import FormCreate from "@/App/Configuration/project/components/FormCreate.vue";

import {
    url,
    idKey,
    formStructure,
} from "@/App/Configuration/project/constants/form.constants";
